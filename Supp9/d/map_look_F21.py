...
Title: map of when F21 was in place. 
Author: Jean Rintoul
Date: 02.02.2023
...
data    = dfFile.to_numpy()[0:nn,1:mm]
mm_AP   = data[0:nn,0]
a,b     = data.shape 
...
carrierdata     = carrierFile.to_numpy()[0:nn,1:mm]
mm_AP           = carrierdata[0:nn,0]
a,b             = carrierdata.shape 
# 

sfFile    = pd.read_csv('prf1000_sum.csv', sep=',')
sfdata    = sfFile.to_numpy()[0:nn,1:mm]
mm_AP     = sfdata[0:nn,0]
a,b       = sfdata.shape 
# 
# print (carrier2data)
