...
Title: shows phantom test of focal electric field from transducer, with 1kHz PRF. 
Author: Jean Rintoul
Date: 02.02.2023
...
dfFile  = pd.read_csv('prf1000_diff.csv', sep=',')
data    = dfFile.to_numpy()[0:17,1:15]
mm_AP   = data[0:17,0]
a,b     = data.shape 
...
carrierFile     = pd.read_csv('prf1000_carrier.csv', sep=',')
carrierdata     = carrierFile.to_numpy()[0:17,1:15]
mm_AP           = carrierdata[0:17,0]
a,b             = carrierdata.shape 
# 

sfFile    = pd.read_csv('prf1000_sum.csv', sep=',')
sfdata    = sfFile.to_numpy()[0:17,1:15]
mm_AP     = sfdata[0:17,0]
a,b       = sfdata.shape 
# 
# print (carrier2data)
