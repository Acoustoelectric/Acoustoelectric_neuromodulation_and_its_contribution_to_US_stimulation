...
Title: leave one out test for 1Hz acoustoelectric neuromodulation. 

This code takes some raw data files and plots the representative plots shown in Fig 4. 
It takes raw recorded data with no sub-sampling so the files are GB per file. 
...
fonts                          = 16
# 
savepath      = '/Users/jeanrintoul/Desktop/PhD/analysis/ae_neuromodulation/final_paper_support_figs_code/Fig4/representative_full_Fs/'
outpath       = savepath

ae_filename   = savepath + 'tae_g500_stream.npy'        # duration 6
p_filename    = savepath + 'tp_p0.18_g500_stream.npy'   # duration 6 
v_filename    = savepath + 'tv_v3_g500_stream.npy'      # duration 6
# 
...
cut             = 1000
sos_low_band    = iirfilter(17, [40], rs=60, btype='lowpass',
